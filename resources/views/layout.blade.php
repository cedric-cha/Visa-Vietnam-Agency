...
<body style="background-color: #F1F1F1">
        ...
        <div class="container">
            <table class="table">
                @isset($order->visa_pdf)
                    <tr>
                        <th scope="row">Your E-Visa is ready</th>
                        <td>
                ...
                @isset($order->fast_track_pdf)
                    <tr>
                        <th scope="row">Your Fast Track confirmation is ready</th>
                        <td>
                            <a href="{{ url('storage/' . $order->fast_track_pdf) }}" target="_blank" class="btn btn-sm text-white" style="background-color: red">
                                Download
                            </a>
                        </td>
                    </tr>
                ...
                @if(str_contains($order->service, \App\Enums\OrderServiceType::EVISA->value))
                    <tr>
    ...
    <script>
        ...
        function displayConfirmMessage(message, action) {
            Swal.fire({
                text: message,
                icon: 'question',
